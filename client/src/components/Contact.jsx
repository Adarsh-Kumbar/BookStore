      ...
      <section class="dark:bg-black dark:text-white">
        <div class="container px-6 py-24 mx-auto">
          <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold text-white md:text-3xl dark:text-white">
              Chat to our friendly team
            </h1>

            <p class="mt-3 text-gray-400 dark:text-gray-400">
          ...
          <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
              <div>
                ...
                <h2 class="mt-4 text-base font-medium text-white dark:text-white">
                  Email
                </h2>
            ...
            <div class="p-4 py-6 rounded-lg bg-gray-400 dark:bg-gray-800 md:p-8">
              <form>
